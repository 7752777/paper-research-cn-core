...
sys.path.insert(0, str(ROOT / "skills" / "paper-manuscript-cn-core" / "scripts"))
sys.path.insert(0, str(ROOT / "skills" / "paper-figure-cn-core" / "scripts"))
sys.path.insert(0, str(ROOT / "skills" / "paper-reference-cn-core" / "scripts"))


class PackageContractTests(unittest.TestCase):
    def test_exactly_six_skills_are_discoverable_and_valid(self) -> None:
